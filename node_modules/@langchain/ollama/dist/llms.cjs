...
var Ollama = class extends __langchain_core_language_models_llms.LLM {
	...
	constructor(fields) {
		...
		this.baseUrl = fields?.baseUrl ? fields?.baseUrl.endsWith("/") ? fields?.baseUrl.slice(0, -1) : fields?.baseUrl : (0, __langchain_core_utils_env.getEnvironmentVariable)("OLLAMA_BASE_URL") ?? this.baseUrl;
